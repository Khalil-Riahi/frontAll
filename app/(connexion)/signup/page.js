        ...
        <div className="w-11/12 max-w-5xl bg-white shadow-lg rounded-xl flex overflow-hidden">
          ...
          <div className="hidden md:flex flex-col justify-center items-center w-1/2 bg-gradient-to-b from-teal-200 to-blue-600 p-8 text-white">
            <div className="flex flex-col justify-center items-center gap-28">
              ...
              <img src="/people-working-drinking-coffee-coworking-area_82574-10622-removebg-preview.png" alt="Sign Up Illustration" className="w-10/12" />
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 p-8">
            ...
            >
              ...
              <div className="flex gap-4">
                <button
                  type="submit"
                  className="w-1/2 bg-green-600 py-2 rounded-md text-white font-semibold hover:bg-green-700 transition"
                >
                  Create account
                </button>
                ...
                <button
                  ...
                  className="flex items-center justify-center border border-gray-300 py-2 px-4 rounded-md font-semibold hover:bg-gray-100 transition"
                >
